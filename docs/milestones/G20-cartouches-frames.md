...
> **Status: ready to build.** The Archive tranche continues on G18's substrate. Three
...
- [ ] No readable English anywhere in the vocabulary layer: block display names are seeded
